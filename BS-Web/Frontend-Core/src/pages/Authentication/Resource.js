...
const Resource = ({ lang }) => {
    ...
    const handleOpenEdit = (row) => {
        setDialogTitleForm("Edit Resource");
        console.log("Edit row data:", row);
        setFormData(row);
        setOpenForm(true);
    };
    const handleOpenAdd = () => {
        setDialogTitleForm("Add Resource");
        ...
        <Box>
            ...
            <Paper sx={{ p: 2, mb: 3 }}>
                <Typography variant="h6" gutterBottom>
                    {resourceData?.find(r => r.resource_name === "Header").resource_value ?? "Resource"}
                </Typography>
                <BSDataGrid
                    bsLocale={lang || "en"}
                    bsPreObj="sec"
            ...
            <Dialog open={openForm} maxWidth="lg" onClose={() => setOpenForm(false)}>
                ...
                <DialogContent>
                    <Grid container spacing={2} sx={{ mt: 1, mb: 1 }}>
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 4 }} >
                            <FormControl fullWidth  >
                                <InputLabel htmlFor="resource_group">Resource Group</InputLabel>
                                <OutlinedInput
                                    id="resource_group"
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 4 }} >
                            <FormControl fullWidth >
                                <InputLabel htmlFor="resource_name">Resource Name</InputLabel>
                                <OutlinedInput
                                    id="resource_name"
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 4 }} >
                            <FormControl fullWidth >
                                <InputLabel htmlFor="resource_en">Resource (EN)</InputLabel>
                                <OutlinedInput
                                    id="resource_en"
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 4 }} >
                            <FormControl fullWidth >
                                <InputLabel htmlFor="resource_th">Resource (TH)</InputLabel>
                                <OutlinedInput
                                    id="resource_th"
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 4 }} >
                            <FormControl fullWidth >
                                <InputLabel htmlFor="resource_other">Resource (Other)</InputLabel>
                                <OutlinedInput
                                    id="resource_other"
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 4 }} >
                            <FormControl fullWidth >
                                <InputLabel htmlFor="description_en">Description (EN)</InputLabel>
                                <OutlinedInput
                                    id="description_en"
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 4 }} >
                            <FormControl fullWidth >
                                <InputLabel htmlFor="description_th">Description (TH)</InputLabel>
                                <OutlinedInput
                                    id="description_th"
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 4 }} >
                            <FormControl fullWidth >
                                <InputLabel htmlFor="descrption_other">Description (Other)</InputLabel>
                                <OutlinedInput
                                    id="descrption_other"
